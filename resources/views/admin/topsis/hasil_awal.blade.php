...
@section('title', 'Hasil Seleksi Tahap 1')

@section('content')
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Hasil Seleksi Tahap 1: Ranking Pelamar Berdasarkan Data Diri</h2>
    </div>

    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-xl font-semibold text-gray-800">Ranking Pelamar</h3>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse ($ranking as $index => $r)
                        {{-- Menggunakan forelse untuk menangani jika ranking kosong --}}
    ...
    <div class="mt-6 flex justify-end"> {{-- Posisi tombol ke kanan --}}
        <a href="{{ url('/admin/topsis/' . $id . '/wawancara') }}"
            ...
            Lanjutkan Input Nilai Wawancara (Top 5)
        </a>
    </div>
@endsection
